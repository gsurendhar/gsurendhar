<h1 align="center">Hi 👋, I'm Surendhar Gonela</h1> <h3 align="center"> DevOps & AWS Cloud Engineer | Kubernetes | CI/CD | Cloud Automation </h3> <p align="center"> Building scalable, secure, and reliable cloud infrastructure 🚀 </p> <p align="center"> <a href="https://linkedin.com/in/surendhar-gonela"> 
...
- 🔐 Implemented DevSecOps quality gates reducing pre-release vulnerabilities by ~40% 
- 🚀 Built reusable CI/CD frameworks adopted across multiple engineering projects 
- 📊 Designed observability pipelines using Prometheus, Grafana, and ELK Stack 
- ☸️ Worked on Amazon EKS production deployments and zero-downtime upgrades 
- 🌱 Currently learning Azure Cloud & advanced Kubernetes ecosystem tools 
- 📝 Sharing knowledge through Medium blogs and LinkedIn posts on DevOps & Cloud > 

*"DevOps is more than automation — it's about collaboration, ownership, and building systems that scale reliably."*
...
| Area | Achievement | 
|---|---| 
| 🔐 DevSecOps | Reduced vulnerabilities by ~40% using automated quality gates | 
| ⚙️ CI/CD | Built reusable CI/CD frameworks across multiple teams |
| ☸️ Kubernetes | Managed EKS production workloads & zero-downtime upgrades | 
| 📊 Observability | Improved troubleshooting with Prometheus, Grafana & ELK | 
